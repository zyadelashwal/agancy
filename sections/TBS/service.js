...
return (
    ...
    <section  className="TBS format service-bg" id="services">
        <Container>
            <Row>
                    ...
                    <div className="center-text">
                        <div className="format-container">
                            ...
                            <div className="format-head-text">
                                <h2 className="about-font-header">{t("services2")} <span className="block-span">
                                {t("provided")} </span></h2>
                            </div>
                            <div className="format-sub-text">
                                <p className="about-para">{t("services3")} </p>
                            </div>
                            {/* <a className=" btn btn-default btn-gradient" href="#about">{t("more")} </a> */}
                        </div>
                    </div>
                </Col>
                <Col lg="7" md="8">
