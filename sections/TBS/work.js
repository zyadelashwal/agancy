...
const Work = () => (
    <section className="TBS counter counter-bg">
        <Container>
            <Row>
                <Col md="3" xs="6" className="counter-container">
                    <div className="counters hover-counter">
                        <img alt="" className="img-fluid counter-img" src="/assets/images/TBS/counter/1.png" />
                ...
                <Col md="3" xs="6" className="counter-container">
                    <div className="counters hover-counter active">
                        <img alt="" className="img-fluid counter-img" src="/assets/images/TBS/counter/2.png" />
                        <div className="counter-text">
                            <div className="count-number">
                ...
                <Col md="3" xs="6" className="counter-container">
                    <div className="counters hover-counter">
                        <img alt="" className="img-fluid counter-img" src="/assets/images/TBS/counter/3.png" />
                        <div className="counter-text">
                            <div className="count-number">
                ...
                <Col md="3" xs="6" className="counter-container">
                    <div className="counters hover-counter">
                        <img alt="" className="img-fluid counter-img" src="/assets/images/TBS/counter/4.png" />
                        <div className="counter-text">
                            <div className="count-number">
