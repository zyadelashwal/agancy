...
const Video = () => {
    ...
    return(
        <section className="TBS video video-bg p-0" id="video">
            <Container>
                <Row>
                    <Col xs="12"  className="p-0">
                        <div className="text-center">
                            <div className="d-inline-block">
                                <img alt="" className="img-fluid bg-video" src="/assets/images/TBS/videos/bg.png" />
                                <div className="abs-center">
                                    <div>
                                        <div className="m-b-20">
                                            <a className="button" href="#javascript" onClick={toggle}>
                                                <img alt="" className="img-fluid video-img"
                                                    src="/assets/images/TBS/videos/icon.png" />
                                            </a>
                                        ...
                                        <div>
                                            <a className="video w-100" href="">
                                                <img alt="" className="img-fluid m-b-20"
                                                    src="/assets/images/TBS/videos/title-icon.png" />
                                            </a>
                                            <div>
